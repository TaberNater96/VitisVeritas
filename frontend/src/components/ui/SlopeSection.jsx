...
const SlopeSection = () => {
  ...
  const slopeData = {
    ...
    '45': {
      ...
      description: 'Extreme slopes represent the absolute limit of viticultural possibility in the Willamette Valley, where slopes approach the angle of repose for loose soil materials at 45%. Vines exist in near-constant water deficit with predawn leaf water potentials never recovering above -8 bars, inducing metabolic changes that fundamentally alter grape composition through enhanced production of stress-response compounds. Soil loss without terracing would exceed 50 tons per acre annually, requiring extensive retention walls and manual transportation of replacement soil. The extreme angle creates a unique radiation environment with up to 30% more UV-B exposure than moderate slopes, triggering protective phenolic synthesis pathways rarely activated in normal vineyard conditions.',
      wineImpact: 'Extreme slope wines transcend conventional wine categories, producing allocation-only bottles that command prices exceeding $200 due to yields below 0.5 tons per acre and dangerous hand-harvesting conditions. The extreme stress induces novel metabolic pathways that create unique flavor compounds not found in wines from lesser slopes, including rare anthocyanin polymers that contribute blue-black colors stable for decades. These wines require minimum 10-year cellaring before the massive phenolic load begins to polymerize and soften, eventually revealing unprecedented aromatic complexity with notes ranging from graphite and crushed volcanic rock to dried violets and aged balsamic. Each bottle represents a heroic viticultural achievement that pushes both vine and winemaker to their absolute limits.'
    }
  };
